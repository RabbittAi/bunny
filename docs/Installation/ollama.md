...
This guide will help you set up Ollama for bunny. Ollama is a tool that allows you to run open-source large language models (LLMs) locally on your machine. It supports varity of models like Llama-2, mistral, code-llama and many more.
...
- if you are using the default address, bunny will automatically detect the server and and fetch the models list.
